...
<head>
    ...
    <title>Report a Sighting — Community Watch</title>
</head>
            ...
            <div class="col-md-8 col-lg-7">
                <div class="form-card">
                    ...
                    <div class="form-card-header">
                        <i class="bi bi-eye"></i>
                        <div>
                            <div class="form-card-title">Report a Sighting</div>
                            <div class="form-card-sub">Think you've seen someone? Share what you know — it could help reunite a family.</div>
                        </div>
                    </div>
                    ...
                    <form action="Volunteer.php" enctype="multipart/form-data" method="post">
                        ...
                        <div class="field-group-label">Missing Person Details</div>
                        <div class="row g-3 mb-3">
                            <div class="col-12">
                                <label class="form-label">Name of Missing Person</label>
                                <input type="text" class="form-control" name="fullname"
                                    placeholder="As listed in the report" required>
                            </div>
                        </div>

                        <div class="field-group-label">Where You Saw Them</div>
                        <div class="row g-3 mb-3">
                            <div class="col-12">
                                <label class="form-label">Address</label>
                                <input type="text" class="form-control" name="address"
                                    placeholder="Street address where you saw them" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="gendesc" rows="4"
                                    placeholder="When and where you saw them, what they were wearing, their condition..."></textarea>
                            </div>
                            <div class="col-12 mt-1">
                                <button type="submit" class="btn-submit" name="upload">
                                    Submit Sighting <i class="bi bi-arrow-right ms-2"></i>
                                </button>
                            </div>
                        </div>
